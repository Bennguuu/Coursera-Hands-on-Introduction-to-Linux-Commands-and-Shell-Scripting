...
- ![#f03c15](https://via.placeholder.com/15/f03c15/000000?text=+) `A shell is a powerful user interface for Unix-like operating systems. It is an interactive scripting language.`
